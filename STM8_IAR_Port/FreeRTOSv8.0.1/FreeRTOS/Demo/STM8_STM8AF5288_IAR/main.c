...
/* 
 * This function initializes the clcok module
 */
...
static volatile unsigned long ulDummyVariable = 3UL;
	...
	( void ) pvParameters;
     ...
     /* Initialise the Back light Led port*/
 ...
 *
 *  \brief  This function initializes the clock module
 *
 *  \param  None
 *
 *  \return None
...
void CLK_Config(void)
{
    /* This need to be enable on final board*/
    /* Clock configuration.set all clock register to reset state*/
    //CLK_DeInit();
    /* Select the External clock source*/
    //CLK_ClockSwitchConfig(CLK_SWITCHMODE_AUTO, CLK_SOURCE_HSE, DISABLE,
    //                      CLK_CURRENTCLOCKSTATE_DISABLE);
    
    /* if clock switch not possible then dont proceed*/
  ...
  /* Clock divider to HSI/2 8MHz Clock*/
